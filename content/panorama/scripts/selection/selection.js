...
// Updates the list of selected entities on server for this player
function SendQueriedEntities() {
    GameEvents.SendCustomGameEventToServer("query_update", {query: GetQueryUnit()})
}
...
(function () {
    ...
    GameEvents.Subscribe( "dota_player_update_query_unit", SendQueriedEntities );
})();