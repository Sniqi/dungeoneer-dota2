...
--[[
  ...
  -Ensure that you have the barebones_notifications.xml, barebones_notifications.js,ure that barebones_notifications.xml is included in your custom_ui_manifest.xm and barebones_notifications.css files in your panorama content folder.
  -Ensl with
