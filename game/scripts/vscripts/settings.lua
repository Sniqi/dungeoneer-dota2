...
HERO_SELECTION_STRATEGY_TIME = 0.0      -- How long should we let people use their strategy time?
PRE_GAME_TIME = 1.0                     -- How long after people select their heroes should the horn blow and the game start?
POST_GAME_TIME = 14.0                   -- How long should we let people look at the scoreboard before closing the server automatically?
SHOWCASE_TIME = 0.0						-- Set the duration of the 'radiant versus dire' showcase screen.
...
--FORCE_PICKED_HERO = "npc_dota_hero_enchantress"
...
VICTORY_MESSAGE = "dungeoneer-dota2.com"
VICTORY_MESSAGE_DURATION = 10            -- How long should we wait after the victory message displays to show the End Screen?  Use 
...
TEAM_COLORS[DOTA_TEAM_GOODGUYS] = { 243, 201, 9 }
