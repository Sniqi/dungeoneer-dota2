...
function lunar_horse_eclipse:OnSpellStart()
	...
	-- Modifier --
	victim:AddNewModifier(caster, self, "lunar_horse_sun_orb_move_range_counter_modifier", {duration = duration})
	-- Modifier --
	victim:AddNewModifier(caster, self, "lunar_horse_sun_orb_countdown_modifier", {duration = duration})
	-- Modifier --
	victim:AddNewModifier(caster, self, "lunar_horse_sun_orb_modifier", {duration = duration})
