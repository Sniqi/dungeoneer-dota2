...
function lunar_horse_lunar_beam:OnSpellStart()
	...
	local turn_rate_percentage        = self:GetSpecialValueFor("turn_rate_percentage")
	...
	RandomLocationMinDistance( GetSpecificBorderPoint("point_center"), 750*RandomFloat(0.25, 1.0))
		...
		-- Modifier --
		victim:AddNewModifier(caster, self, "lunar_horse_lunar_beam_modifier", {duration = duration})
		-- Modifier --
		victim:AddNewModifier(caster, self, "lunar_horse_lunar_beam_turning_modifier", {duration = duration})
