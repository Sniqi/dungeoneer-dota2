...
function demonic_warrior_rest:OnSpellStart()
	...
	-- Modifier --
	victim:AddNewModifier(caster, self, "demonic_warrior_rest_modifier", {duration = duration})
	-- Modifier --
	victim:AddNewModifier(caster, self, "demonic_warrior_rest_enhancement_modifier", {duration = duration})
	-- Modifier --
	victim:AddNewModifier(caster, self, "demonic_warrior_rest_checker_modifier", {duration = duration})
