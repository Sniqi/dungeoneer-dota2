...
function drono_red_dragonkin_commander_red_dragon_army:OnSpellStart()
	...
	local killed_dragonkin_damage_to_drono_percentage= self:GetSpecialValueFor("killed_dragonkin_damage_to_drono_percentage")
	...
	-- Modifier --
	victim:AddNewModifier(caster, self, "drono_red_dragonkin_commander_red_dragon_army_modifier", {duration = duration})
	-- Modifier --
	victim:AddNewModifier(caster, self, "drono_red_dragonkin_commander_red_dragonkin_armor_modifier", {duration = duration})
