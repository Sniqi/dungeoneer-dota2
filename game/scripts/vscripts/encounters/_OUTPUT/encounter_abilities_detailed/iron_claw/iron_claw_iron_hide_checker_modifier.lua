...
function iron_claw_iron_hide_checker_modifier:GetModifierPhysicalArmorBonus( params )
	return self.armor
end

function iron_claw_iron_hide_checker_modifier:GetModifierMagicalResistanceBonus( params )
	return self.magic_resist_percentage
end

function iron_claw_iron_hide_checker_modifier:GetModifierStatusResistanceStacking( params )
	return self.status_resistance_percentage
end

function iron_claw_iron_hide_checker_modifier:GetModifierMoveSpeedBonus_Percentage( params )
