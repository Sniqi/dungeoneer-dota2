...
function iron_claw_absorbing_skin:OnSpellStart()
	...
	local move_speed_limit_ignore     = self:GetSpecialValueFor("move_speed_limit_ignore")
	...
	-- Modifier --
	victim:AddNewModifier(caster, self, "iron_claw_absorbing_skin_modifier", {duration = duration})
	-- Modifier --
	victim:AddNewModifier(caster, self, "iron_claw_absorbing_skin_attack_damage_modifier", {duration = duration})
	-- Modifier --
	victim:AddNewModifier(caster, self, "iron_claw_absorbing_skin_move_speed_modifier", {duration = duration})
