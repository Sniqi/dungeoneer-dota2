...
function the_curse_of_agony_curse_or_get_worse:OnSpellStart()
	...
	RandomLocationMinDistance( GetSpecificBorderPoint("point_center"), 750*RandomFloat(0.25, 1.0))
		...
		-- Modifier --
		victim:AddNewModifier(caster, self, "the_curse_of_agony_curse_or_get_worse_buff_modifier", {duration = duration})
		-- Modifier --
		victim:AddNewModifier(caster, self, "the_curse_of_agony_curse_or_get_worse_debuff_modifier", {duration = duration})
