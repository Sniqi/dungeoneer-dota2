...
function the_curse_of_agony_banish:OnSpellStart()
	...
	RandomLocationMinDistance( GetSpecificBorderPoint("point_center"), 750*RandomFloat(0.25, 1.0))
		...
		-- Modifier --
		victim:AddNewModifier(caster, self, "the_curse_of_agony_the_curse_modifier", {duration = duration})
		-- Modifier --
		victim:AddNewModifier(caster, self, "the_curse_of_agony_banished_modifier", {duration = duration})
