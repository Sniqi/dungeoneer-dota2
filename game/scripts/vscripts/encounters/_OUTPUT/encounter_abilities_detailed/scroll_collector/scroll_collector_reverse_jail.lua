...
function scroll_collector_reverse_jail:OnSpellStart()
	...
	RandomLocationMinDistance( GetSpecificBorderPoint("point_center"), 750*RandomFloat(0.25, 1.0))
		...
		-- Modifier --
		victim:AddNewModifier(caster, self, "scroll_collector_reverse_jail_safe_zone_modifier", {duration = duration})
		-- Modifier --
		victim:AddNewModifier(caster, self, "scroll_collector_reverse_jail_damage_modifier", {duration = duration})
