...
function the_dungeoneer_reshape_ground:OnSpellStart()
	...
	RandomLocationMinDistance( GetSpecificBorderPoint("point_center"), 750*RandomFloat(0.25, 1.0))
		...
		-- Modifier --
		victim:AddNewModifier(caster, self, "the_dungeoneer_reshaped_ground_poison_modifier", {duration = duration})
		-- Modifier --
		victim:AddNewModifier(caster, self, "the_dungeoneer_reshaped_ground_ice_modifier", {duration = duration})
		-- Modifier --
		victim:AddNewModifier(caster, self, "the_dungeoneer_reshaped_ground_earth_modifier", {duration = duration})
